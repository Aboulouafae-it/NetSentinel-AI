...
subtitle: "Local-First Network Observability, Cybersecurity & Wireless Diagnostics Platform"
author: "Author / Founder: [Name Placeholder]"
date: "2026-05-06"
version: "MVP / Project Foundation Dossier"
...
**Classification:** Confidential - Internal Project and Partner Evaluation  
**Recommended PDF filename:** `NetSentinel-AI_Project-Foundation-Dossier_v0.1.pdf`

> **Confidentiality Notice**  
> This document contains project strategy, architecture, technical design, product positioning, and security planning information for NetSentinel AI. It is intended for authorized reviewers, founders, engineers, cybersecurity professionals, network administrators, investors, public institutions, and enterprise evaluation teams. Do not distribute without permission from the project owner.
...
# 22. Business and Product Positioning
...
# 25. PDF Export Instructions

This Markdown file is ready to export to PDF. Mermaid rendering support depends on the selected tool.

## Option A: Pandoc

Best for formal PDF export. Mermaid diagrams may require pre-rendering to images or a Mermaid filter.

```bash
pandoc docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.md \
  -o docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.pdf \
  --toc \
  --pdf-engine=xelatex
```

If Mermaid diagrams are not rendered by your Pandoc setup, export them separately with Mermaid CLI and replace Mermaid blocks with images.

## Option B: VS Code Markdown PDF Extension

1. Open `docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.md`.
2. Install the "Markdown PDF" extension.
3. Run "Markdown PDF: Export (pdf)" from the command palette.
4. Save as `NetSentinel-AI_Project-Foundation-Dossier_v0.1.pdf`.

## Option C: Typst

Typst is excellent for polished documents, but this Markdown file should first be converted or manually adapted into Typst syntax.

```bash
pandoc docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.md \
  -t typst \
  -o docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.typ

typst compile docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.typ \
  docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.pdf
```

## Option D: WeasyPrint

Convert Markdown to HTML first, then render HTML to PDF.

```bash
pandoc docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.md \
  -o docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.html \
  --standalone \
  --toc

weasyprint docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.html \
  docs/NetSentinel-AI_Project-Foundation-Dossier_v0.1.pdf
```

## Option E: Playwright HTML-to-PDF

Convert the Markdown to HTML, then use Playwright or a small Node script to print the HTML to PDF. This method can produce strong browser-quality layout and can render Mermaid if the HTML includes Mermaid JavaScript.

Recommended final PDF filename:

```text
NetSentinel-AI_Project-Foundation-Dossier_v0.1.pdf
```
