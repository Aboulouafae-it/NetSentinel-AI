...
Boots the prototype ISO in QEMU with user-mode networking and a serial console.
...
echo "Booting NetSentinel AI prototype ISO:"
echo "  ${ISO_PATH}"
echo "Forwarded ports:"
echo "  host 3000 -> guest 3000"
echo "  host 8000 -> guest 8000"
echo "After boot, try: http://localhost:3000/setup"
